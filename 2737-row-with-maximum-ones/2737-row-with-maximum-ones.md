<h1>2737 - Row With Maximum Ones</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/row-with-maximum-ones/">row-with-maximum-ones</a></h2><p>Given a <code>m x n</code> binary matrix <code>mat</code>, find the <strong>0-indexed</strong> position of the row that contains the <strong>maximum</strong> count of <strong>ones,</strong> and the number of ones in that row.</p>
