<h1>2547 - Odd String Difference</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/odd-string-difference/">odd-string-difference</a></h2><p>You are given an array of equal-length strings <code>words</code>. Assume that the length of each string is <code>n</code>.</p>
