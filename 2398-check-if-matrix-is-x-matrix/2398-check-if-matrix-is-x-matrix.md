<h1>2398 - Check if Matrix Is X-Matrix</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-matrix-is-x-matrix/">check-if-matrix-is-x-matrix</a></h2><p>A square matrix is said to be an <strong>X-Matrix</strong> if <strong>both</strong> of the following conditions hold:</p>
