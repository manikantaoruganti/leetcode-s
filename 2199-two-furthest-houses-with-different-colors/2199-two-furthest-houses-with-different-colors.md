<h1>2199 - Two Furthest Houses With Different Colors</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/two-furthest-houses-with-different-colors/">two-furthest-houses-with-different-colors</a></h2><p>There are <code>n</code> houses evenly lined up on the street, and each house is beautifully painted. You are given a <strong>0-indexed</strong> integer array <code>colors</code> of length <code>n</code>, where <code>colors[i]</code> represents the color of the <code>i<sup>th</sup></code> house.</p>
