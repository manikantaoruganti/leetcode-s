<h1>2536 - Determine if Two Events Have Conflict</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/determine-if-two-events-have-conflict/">determine-if-two-events-have-conflict</a></h2><p>You are given two arrays of strings that represent two inclusive events that happened <strong>on the same day</strong>, <code>event1</code> and <code>event2</code>, where:</p>
