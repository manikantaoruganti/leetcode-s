<h1>1843 - Number Of Rectangles That Can Form The Largest Square</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/number-of-rectangles-that-can-form-the-largest-square/">number-of-rectangles-that-can-form-the-largest-square</a></h2><p>You are given an array <code>rectangles</code> where <code>rectangles[i] = [l<sub>i</sub>, w<sub>i</sub>]</code> represents the <code>i<sup>th</sup></code> rectangle of length <code>l<sub>i</sub></code> and width <code>w<sub>i</sub></code>.</p>
