<h1>2797 - Event Emitter</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/event-emitter/">event-emitter</a></h2><p>Design an <code>EventEmitter</code> class. This interface&nbsp;is similar (but with some differences) to the one found in Node.js or the Event Target interface of the DOM. The <code>EventEmitter</code> should allow for subscribing to events and emitting them.</p>
