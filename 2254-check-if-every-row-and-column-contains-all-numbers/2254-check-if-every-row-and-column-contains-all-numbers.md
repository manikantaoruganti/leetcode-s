<h1>2254 - Check if Every Row and Column Contains All Numbers</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-if-every-row-and-column-contains-all-numbers/">check-if-every-row-and-column-contains-all-numbers</a></h2><p>An <code>n x n</code> matrix is <strong>valid</strong> if every row and every column contains <strong>all</strong> the integers from <code>1</code> to <code>n</code> (<strong>inclusive</strong>).</p>
